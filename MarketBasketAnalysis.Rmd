---
title: "Market Basket Analysis Assignment"
author: "Krupan"
...
#### Steps to achieve: 
   ...
   4. Analysis on Rules
   5. Identifying and Removing Redudant Rules
...
We passed two parameters to apriori function. 
 ...
 2. List of parameters.  
    ...
    Minimum Length = 2 => Minimum length of rule should be 2; which means rule should contains atleast two items involved.      Maximum Length = 5
...
#### Step 5: Identifying and Removing Redudant Rules


From the above list of rules, we can see some redudancy. 
...
__Grouped Plot:__ This plots the LHS items and RHS items with lines connecting and bubbles placed on the intersection of LHS and RHS items. Sixe of the bubble represents Support and color represents the Lift.  
...
```
__Graph Plot:__ This plots the Items in Green bubbles and the associations between the Items are joined with arrows with the bubble in between. Sixe represents the Support and color represents the lift.  
...
```{r GraphPlotMagazine, message = FALSE, warning = FALSE}
